...
# Load the dataset
df = pd.read_csv('rating_filtered.csv')

# Normalize the 'fuzzy_rating' and 'label' columns to a 0-1 range
...
# Apply normalization to both 'label' and 'fuzzy_rating' columns
df['normalized_label'] = df['label'].apply(normalize_to_01)
